...
class MusicScannerTest {
    ...
    fun setUp() {
        ...
        musicList = listOf(
            ...
            MusicTrack(1L, "", 1, "Fron the Inside", "Meteora", "LinkinPark", Uri.EMPTY),
    ...
    @Test
    fun `detect number of albums in list`(){
        assertThat(musicScanner.scanForAlbum(musicList).size).isEqualTo(3)
    }
}